...
package org.nyeriumj.tools;

import org.nyeriumj.core.*;
import org.nyeriumj.crypto.*;
import org.nyeriumj.net.discovery.DnsDiscovery;
import org.nyeriumj.params.MainNetParams;
import org.nyeriumj.params.RegTestParams;
import org.nyeriumj.params.TestNet3Params;
import org.nyeriumj.protocols.payments.PaymentProtocol;
import org.nyeriumj.protocols.payments.PaymentProtocolException;
import org.nyeriumj.protocols.payments.PaymentSession;
import org.nyeriumj.script.ScriptBuilder;
import org.nyeriumj.store.*;
import org.nyeriumj.uri.NyeriumURI;
import org.nyeriumj.uri.BitcoinURIParseException;
import org.nyeriumj.utils.BriefLogFormatter;
import org.nyeriumj.wallet.DeterministicSeed;
import org.nyeriumj.wallet.DeterministicUpgradeRequiredException;
import org.nyeriumj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.nyeriumj.core.listeners.BlocksDownloadedEventListener;
import org.nyeriumj.core.listeners.DownloadProgressTracker;
import org.nyeriumj.wallet.MarriedKeyChain;
import org.nyeriumj.wallet.Protos;
import org.nyeriumj.wallet.SendRequest;
import org.nyeriumj.wallet.Wallet;
import org.nyeriumj.wallet.WalletExtension;
import org.nyeriumj.wallet.WalletProtobufSerializer;
...
import static org.nyeriumj.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    NyeriumURI paymentRequestURI = new NyeriumURI(location);
