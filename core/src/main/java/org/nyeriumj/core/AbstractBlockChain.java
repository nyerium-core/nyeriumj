 ...
 * the lightweight SPV mode, a {@link org.nyeriumj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.nyeriumj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
...
public abstract class AbstractBlockChain {
    ...
    private void checkDifficultyTransitions_V2(StoredBlock storedPrev, Block nextBlock) throws BlockStoreException, VerificationException {
        final long      	BlocksTargetSpacing			= (long)(1 * 60); // 10 minutes
