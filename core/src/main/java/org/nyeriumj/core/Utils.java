...
public class Utils {
    ...
    public static long getTotalCoinEstimate(int nHeight) //EK TO ESTIMATE
    {
        long nTotalCoins = 0;
        ...
        if(nHeight > 5076) nTotalCoins += 13722069;
        if(nHeight > 17000) nTotalCoins += 13722069-13722069;
        if(nHeight > 34000) nTotalCoins += 15872218-13722069;
        if(nHeight > 67000) nTotalCoins += 17982265-15872218;

        if(nHeight > 67000*2) {
            nTotalCoins += 17982265-15872218;
        } else {
            return nTotalCoins;
        }

        //5.383754730451325 per block average after this
        nTotalCoins += ((nHeight-67000*2)*((18000000-15872218)/(67000*2)));
