...
import org.nyeriumj.net.*;
import org.nyeriumj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of nyeriumj fixes the known
    ...
    /** See {@link this.Peer#addDiscoveredEventListener(PeerDiscoveredEventListener)} */
     ...
     * {@link org.nyeriumj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.nyeriumj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.nyeriumj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.nyeriumj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.nyeriumj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.nyeriumj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.nyeriumj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.nyeriumj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.nyeriumj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a nyeriumj based app running in SPV mode to fully validating security.
     */
