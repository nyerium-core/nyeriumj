...
import org.nyeriumj.crypto.TransactionSignature;
...
//EK TODO HERE ADD ISZCSPEND FROM nyeriumj-MASTER
                if (in.hasSequence()) {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.nyeriumj.script.Script, ECKey, org.nyeriumj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.nyeriumj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link org.nyeriumj.core.TxConfidenceTable}
