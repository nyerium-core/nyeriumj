...
public class MasterNodeSystem {
    ...
    public final static int MASTERNODE_MIN_DSEEP_SECONDS           = (10*60);
    public final static int MASTERNODE_MIN_DSEE_SECONDS            = (5*60)    ;
    public final static int MASTERNODE_PING_SECONDS                = (5*60)   ;
    public final static int MASTERNODE_EXPIRATION_SECONDS          = (120*60) ;
    public final static int MASTERNODE_REMOVAL_SECONDS             = (130*60);
    public final static int MASTERNODE_CHECK_SECONDS               = 5;
    ...
    static final int nMasternodeMinProtocol= 70003;
