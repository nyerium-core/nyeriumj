...
public class VersionMessage extends Message {
    ...
    public static final String BITCOINJ_VERSION = "1.0.3";  //EK VERSION TO TEST. FILENAME SHOULD MATCH THIS
    ...
    public VersionMessage(NetworkParameters params, int newBestHeight) {
        ...
        try {
            ...
            //theirAddr = new PeerAddress(InetAddresses.forString("35.154.221.49"), params.getPort(), 0);
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for nyeriumj
     * users might look like "/nyeriumj:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/nyeriumj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
