...
import static org.nyeriumj.core.MasterNodeSystem.MASTERNODE_REMOVAL_SECONDS;
...
//                Misbehaving(pfrom->GetId(), nDoS);
    ...
    public int getEstimatedMasternodes(int nBlock) //EK TODO STUDY
    {
    /*
    ...
    */
        ...
        int nPeriod = 35040;
        int nCollateral = 25000; //EK was 1000
