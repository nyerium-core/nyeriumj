...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.nyeriumj.store.SPVBlockStore} or you could also try a
     * {@link org.nyeriumj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
