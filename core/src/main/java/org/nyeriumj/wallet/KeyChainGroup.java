...
/**
 * <p>A KeyChainGroup is used by the {@link org.nyeriumj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.nyeriumj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.nyeriumj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.nyeriumj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
