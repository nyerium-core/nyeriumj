...
import org.nyeriumj.core.Message;
import org.nyeriumj.core.listeners.*;
import org.nyeriumj.core.TransactionConfidence.*;
import org.nyeriumj.crypto.*;
import org.nyeriumj.script.*;
import org.nyeriumj.signers.*;
import org.nyeriumj.utils.*;
import org.nyeriumj.wallet.Protos.Wallet.*;
import org.nyeriumj.wallet.WalletTransaction.*;
import org.nyeriumj.wallet.listeners.KeyChainEventListener;
import org.nyeriumj.wallet.listeners.ScriptsChangeEventListener;
import org.nyeriumj.wallet.listeners.WalletChangeEventListener;
import org.nyeriumj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.nyeriumj.wallet.listeners.WalletCoinsSentEventListener;
import org.nyeriumj.wallet.listeners.WalletEventListener;
import org.nyeriumj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.nyeriumj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_NYEX_ONLY? 1 : 0;
     ...
     * {@link org.nyeriumj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.nyeriumj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.nyeriumj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.nyeriumj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.nyeriumj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.nyeriumj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.nyeriumj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.nyeriumj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.nyeriumj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.nyeriumj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.nyeriumj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.nyeriumj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.nyeriumj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of nyeriumj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.nyeriumj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.nyeriumj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.nyeriumj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.nyeriumj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.nyeriumj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.nyeriumj.crypto.KeyCrypter,
     ...
     * {@link org.nyeriumj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.nyeriumj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.nyeriumj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.nyeriumj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.nyeriumj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.nyeriumj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
