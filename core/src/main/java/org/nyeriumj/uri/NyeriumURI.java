...
import org.nyeriumj.params.AbstractBitcoinNetParams;
...
public class NyeriumURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.nyeriumj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.nyeriumj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new NyeriumURI from the given string. Can be for any network.
     *
     ...
     */
    public NyeriumURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public NyeriumURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("NyeriumURI[");
        boolean first = true;
