...
import org.nyeriumj.protocols.channels.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV nyeriumj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit nyeriumj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing nyeriumj
...
public class WalletAppKit extends AbstractIdleService {
    ...
    public WalletAppKit(Context context, File directory, String filePrefix) {
        ...
        context.initNyerium(true, true);
        context.initNyeriumSync(directory.getAbsolutePath());
    }
     ...
     * {@link this.org.nyeriumj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the nyeriumj website for further details.
     */
