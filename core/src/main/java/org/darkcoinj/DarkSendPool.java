...
import org.nyeriumj.utils.ContextPropagatingThreadFactory;
...
public class DarkSendPool {
    ...
    static final int MIN_PEER_PROTO_VERSION = 70003;
    ...
    */
    ...
    public boolean startBackgroundProcessing()
    {
        ...
        {
            //ek -- threadCheckDarkSendPool = new ThreadCheckDarkSendPool();
