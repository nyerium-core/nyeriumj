...
public class NetworkAbstractionTests {
    ...
    public void testNullGetNewParser() throws Exception {
        ...
        }, new InetSocketAddress("localhost", 57418));
        server.startAsync();
        server.awaitRunning();
        ...
        openConnection(new InetSocketAddress("localhost", 57418), clientHandler);
        ...
        MessageWriteTarget client = openConnection(new InetSocketAddress("localhost", 57418), clientHandler);
    ...
    public void basicTimeoutTest() throws Exception {
        ...
        openConnection(new InetSocketAddress("localhost", 57418), new ProtobufConnection<TwoWayChannelMessage>(
                new ProtobufConnection.Listener<Protos.TwoWayChannelMessage>() {
                    @Override
                    public void messageReceived(ProtobufConnection<TwoWayChannelMessage> handler, Protos.TwoWayChannelMessage msg) {
                        fail.set(true);
        ...
        openConnection(new InetSocketAddress("localhost", 57418), client2Handler);
    ...
    public void testConnectionEventHandlers() throws Exception {
        ...
        MessageWriteTarget client1 = openConnection(new InetSocketAddress("localhost", 57418), client1Handler);
        ...
        NioClient client3 = new NioClient(new InetSocketAddress("localhost", 57418), client3Handler, 0);
