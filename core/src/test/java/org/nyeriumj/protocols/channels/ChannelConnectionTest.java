...
import static org.nyeriumj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.nyeriumj.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private void exectuteSimpleChannelTest(KeyParameter userKeySetup) throws Exception {
        ...
        server.bindAndStart(57418);

        PaymentChannelClientConnection client = new PaymentChannelClientConnection(
                new InetSocketAddress("localhost", 57418), 30, wallet, myKey, COIN, "", PaymentChannelClient.DEFAULT_TIME_WINDOW, userKeySetup, versionSelector);
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.nyeriumj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
