...
import org.nyeriumj.core.listeners.TransactionConfidenceEventListener;
import org.nyeriumj.core.AbstractBlockChain;
import org.nyeriumj.core.Address;
import org.nyeriumj.core.Block;
import org.nyeriumj.core.BlockChain;
import org.nyeriumj.core.Coin;
import org.nyeriumj.core.ECKey;
import org.nyeriumj.core.InsufficientMoneyException;
import org.nyeriumj.core.PeerAddress;
...
import org.nyeriumj.core.TransactionOutPoint;
import org.nyeriumj.core.TransactionOutput;
import org.nyeriumj.core.Utils;
import org.nyeriumj.core.VerificationException;
import org.nyeriumj.core.TransactionConfidence.ConfidenceType;
import org.nyeriumj.crypto.*;
import org.nyeriumj.script.Script;
import org.nyeriumj.script.ScriptBuilder;
import org.nyeriumj.signers.StatelessTransactionSigner;
import org.nyeriumj.signers.TransactionSigner;
import org.nyeriumj.store.BlockStoreException;
import org.nyeriumj.store.MemoryBlockStore;
import org.nyeriumj.testing.*;
import org.nyeriumj.utils.ExchangeRate;
import org.nyeriumj.utils.Fiat;
import org.nyeriumj.utils.Threading;
import org.nyeriumj.wallet.Wallet.BalanceType;
import org.nyeriumj.wallet.WalletTransaction.Pool;
...
import org.nyeriumj.wallet.Protos.Wallet.EncryptionType;
...
import static org.nyeriumj.core.Utils.HEX;
import static org.nyeriumj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: nyeriumj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("nyeriumj-unit-test", null);
    ...
    public void keyRotationHD2() throws Exception {
        ...
        assertEquals("NcnKb6X4M4aBofqFPro1wDMz8FBmEei7ty", usedKey.toAddress(PARAMS).toString());
